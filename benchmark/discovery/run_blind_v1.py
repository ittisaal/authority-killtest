...
def summarize(rows):
    ...
    return {
        ...
        "note": (
            "These are raw target-blind discovery outputs. Candidate-label counts are not "
            "repository prevalence and are not scored against target properties here."
        ),
    }
...
def main():
    ...
    forbidden = {"target_property", "expected_label", "label"}
    ...
    result = {
        "experiment": manifest.get("experiment", "blind-v1"),
