...
def summarize(rows):
    ...
    return {
        ...
        "note": "Raw blind-v4 target-blind outputs. Candidate counts are not prevalence and are not scored against withheld targets here.",
    }
...
def main():
    ...
    result = {
        "experiment": manifest.get("experiment", "blind-v4"),
