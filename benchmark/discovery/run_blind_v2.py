...
def summarize(rows):
    ...
    return {
        ...
        "note": (
            "Raw blind-v2 target-blind outputs. Candidate counts are not prevalence and "
            "are not scored against withheld target properties in this file."
        ),
    }
...
def main():
    ...
    result = {
        "experiment": manifest.get("experiment", "blind-v2"),
